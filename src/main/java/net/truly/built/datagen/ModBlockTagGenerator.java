    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(ModBlocks.CHUNKY_BRICKS.get(),
                        ...
                        ModBlocks.CUT_MOSSY_COBBLESTONE.get(),
                        ModBlocks.CUT_MOSSY_COBBLESTONE_STAIRS.get(),
                        ModBlocks.CUT_MOSSY_COBBLESTONE_SLAB.get(),
        ...
        this.tag(BlockTags.WALLS)
                .add(ModBlocks.CHUNKY_BRICK_WALL.get(),
                        ...
                        ModBlocks.CUT_MOSSY_COBBLESTONE_WALL.get(),
